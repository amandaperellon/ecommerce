...
class User extends Model{
	...
	public static function getFromSession(){
		...
		if(isset($_SESSION[User::SESSION]) && (int)isset($_SESSION[User::SESSION]['iduser']) > 0){
	...
	public static function verifyLogin($inadmin = true){
		...
		if(!User::checkLogin($inadmin)){
			...
			if($inadmin){
				...
				header("Location: /curso1/ECommerce/index.php/admin/login");
		...
		if(count($results) === 0){
			...
			if (count($results2) === 0) {
				...
				if($inadmin === true){
					...
					$link = "http://127.0.0.1/curso1/ECommerce/index.php/admin/forgot/reset?code=$result";

				}else{

					$link = "http://127.0.0.1/curso1/ECommerce/index.php/forgot/reset?code=$result";
				}
