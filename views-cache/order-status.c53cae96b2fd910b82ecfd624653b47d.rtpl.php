...
<div class="content-wrapper">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="/curso1/ECommerce/admin/orders">Pedidos</a></li>
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <?php } ?>
            <!-- form start -->
            <form role="form" action="/curso1/ECommerce/index.php/admin/orders/<?php echo htmlspecialchars( $order["idorder"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/status" method="post">
                <div class="box-body">
