...
<div class="content-wrapper">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="/curso1/ECommerce/index.php/admin/orders">Pedidos</a></li>
        <li class="active"><a href="/curso1/ECommerce/index.php/admin/orders/<?php echo htmlspecialchars( $order["idorder"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">Pedido N°<?php echo htmlspecialchars( $order["idorder"], ENT_COMPAT, 'UTF-8', FALSE ); ?></a></li>
    </ol>
    </section>
    ...
    <section class="invoice">
        ...
        <div class="row">
            ...
            <h2 class="page-header">
                <img src="/curso1/ECommerce/res/site/img/logo.png" alt="Logo">
        ...
        <div class="row no-print">
            <div class="col-xs-12">
                <button type="button" onclick="window.location.href = '/curso1/ECommerce/index.php/admin/orders/<?php echo htmlspecialchars( $order["idstatus"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/status'" class="btn btn-default pull-left" style="margin-left: 5px;">
                    <i class="fa fa-pencil"></i> Editar Status
                </button>
                <button type="button" onclick="window.open('/curso1/ECommerce/index.php/boleto/<?php echo htmlspecialchars( $order["idstatus"], ENT_COMPAT, 'UTF-8', FALSE ); ?>')" class="btn btn-default pull-left" style="margin-left: 5px;">
