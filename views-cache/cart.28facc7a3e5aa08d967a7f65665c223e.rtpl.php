            ...
            <div class="col-md-12">
                <div class="product-content-right">
                    <div class="woocommerce">
                        ...
                        <form action="/curso1/ECommerce/index.php/checkout">
                                ...
                                <tbody>
                                    ...
                                    <tr class="cart_item">
                                        <td class="product-remove">
                                            <a title="Removeesses items" class="remove" href="/curso1/ECommerce/index.php/cart/<?php echo htmlspecialchars( $value1["idproduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/remove">×</a> 
                                        </td>

                                        <td class="product-thumbnail">
                                            <a href="/curso1/ECommerce/index.php/product/<?php echo htmlspecialchars( $value1["desurl"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"><img width="145" height="145" alt="poster_1_up" class="shop_thumbnail" src="<?php echo htmlspecialchars( $value1["desphoto"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"></a>
                                        </td>
                                        ...
                                        <td class="product-quantity">
                                            <div class="quantity buttons_added">
                                                <input type="button" class="minus" value="-" onclick="window.location.href = '/curso1/ECommerce/index.php/cart/<?php echo htmlspecialchars( $value1["idproduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/minus'">
                                                ...
                                                <input type="button" class="plus" value="+" onclick="window.location.href = '/curso1/ECommerce/index.php/cart/<?php echo htmlspecialchars( $value1["idproduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/add'">
                                            </div>
                                        </td>
                            ...
                            <div class="cart-collaterals">
                                ...
                                <div class="cross-sells">
                                    ...
                                    <div class="coupon">
                                        ...
                                        <input type="submit" formmethod="post" formaction="/curso1/ECommerce/index.php/cart/freight" value="CÁLCULAR" class="button">
                                    </div>
