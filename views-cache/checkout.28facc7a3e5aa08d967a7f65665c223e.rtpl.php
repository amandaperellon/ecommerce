		...
		<div class="row">
			<div class="col-md-12">
				<div class="product-content-right">
					<form action="/curso1/ECommerce/index.php/checkout" class="checkout" method="post" name="checkout">
								...
								<div class="col-md-12">
									...
									<div class="woocommerce-billing-fields">
										...
										<p id="billing_address_1_field" class="form-row form-row-wide address-field validate-required">
											...
											<input type="submit" value="Atualizar CEP" id="place_order" class="button alt" formaction="/curso1/ECommerce/index.php/checkout" formmethod="get">
										</p>
										<div class="row">
											<div class="col-sm-9">
												<p id="billing_address_1_field" class="form-row form-row-wide address-field validate-required">
										...
										<div id="order_review" style="position: relative;">
											...
											<p id="billing_state_field" class="form-row form-row-first address-field validate-state" data-o_class="form-row form-row-first address-field validate-state">
												<input type="radio" checked="checked" id="method-pagseguro" name="method-payment" placeholder="País" value="1" style="float:left, margin: 30px;">
												<label class"" for="method-pagseguro"><img style="height: 64px;" src="/curso1/ECommerce/res/site/img/logo-pagseguro.png"> </label>
											</p>

											<p id="billing_state_field" class="form-row form-row-first address-field validate-state" data-o_class="form-row form-row-first address-field validate-state">
												<input type="radio" id="method-paypal" name="method-payment" placeholder="País" value="2">
												<label class"" for="method-paypal"><img style="height: 64px;" src="/curso1/ECommerce/res/site/img/logo-paypal.png"> </label>
											</p>
