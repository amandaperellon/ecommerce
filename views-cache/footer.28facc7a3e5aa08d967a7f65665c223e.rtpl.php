<?php if(!class_exists('Rain\Tpl')){exit;}?><div class="footer-top-area">
    ...
    <!-- jQuery sticky menu -->
    <script src="/curso1/ECommerce/res/site/js/owl.carousel.min.js"></script>
    <script src="/curso1/ECommerce/res/site/js/jquery.sticky.js"></script>orem ipsum dolor sit amet, consectetur adipisicing elit. Perferendis sunt id doloribus vero quam laborum quas alias dolores blanditiis iusto consequatur, modi aliquid eveniet eligendi iure eaque ipsam iste, pariatur omnis sint! Suscipit, debitis, quisquam. Laborum commodi veritatis magni at?

  
    
    <!-- jQuery easing -->
    <script src="/curso1/ECommerce/res/site/js/jquery.easing.1.3.min.js"></script>
    
    <!-- Main Script -->
    <script src="/curso1/ECommerce/res/site/js/main.js"></script>
    
    <!-- Slider -->
    <script type="text/javascript" src="/curso1/ECommerce/res/site/js/bxslider.min.js"></script>
	<script type="text/javascript" src="/curso1/ECommerce/res/site/js/script.slider.js"></script>
  </body>
</html>