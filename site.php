...
$app->get('/cart/:idproduct/minus', function($idproduct) {  //irá apagar só um
...
$app->get('/cart/:idproduct/remove', function($idproduct) { //irá remover todos
...
$app->post("/checkout", function(){
	...
	if(!isset($_POST['zipcode']) || $_POST['zipcode'] === ''){
		...
		header("Location: /curso1/ECommerce/index.php/checkout");
		exit;
	}
...
$app->post('/forgot', function() {
	...
	header("Location: /curso1/ECommerce/index.php/forgot/sent");
	exit;
...
$app->get("/boleto/:idorder", function($idorder){
	...
	$path = $_SERVER['DOCUMENT_ROOT'] . DIRECTORY_SEPARATOR . "curso1" . DIRECTORY_SEPARATOR . "ECommerce" . DIRECTORY_SEPARATOR . "res" . DIRECTORY_SEPARATOR . "boletophp" . DIRECTORY_SEPARATOR . "include" . DIRECTORY_SEPARATOR;
...
$app->post("/profile/change-password", function(){
	...
	if(!isset($_POST['current_pass']) || $_POST['current_pass'] === ''){
		...
		header("Location: /curso1/ECommerce/index.php/profile/change-password");
		exit;
	}
